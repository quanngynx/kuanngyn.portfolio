...
export function NotionHeading({ level, richText, slug }: Props) {
  ...
  const levelStyles = {
    1: "text-3xl font-bold tracking-tight text-white mt-10 mb-4 border-b border-neutral-800 pb-2",
    2: "text-2xl font-semibold tracking-tight text-white mt-8 mb-3",
    3: "text-xl font-medium tracking-tight text-neutral-200 mt-6 mb-2",
  };
