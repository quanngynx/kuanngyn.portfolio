...
interface StoryModalProps {
    ...
    project: StoryItem | null;
}

export function StoryModal({ open, onOpenChange, project }: StoryModalProps) {
    useLenisModal(open);
        ...
        <Dialog open={open} onOpenChange={onOpenChange}>
            ...
            >
                <DialogHeader className="sr-only">
                    ...
                    <DialogDescription>{tModals('projectDetails')} {project.title}</DialogDescription>
                </DialogHeader>
                ...
                <div className="overflow-y-auto w-full h-full flex-1" data-lenis-prevent="true">
                    ...
                    <div className="p-6 sm:p-10 flex flex-col gap-10">
                        <div>
                            <h3 className="text-sm tracking-widest text-muted-foreground uppercase mb-4">{tModals('aboutProject')}</h3>
                        ...
                        {project.stack && project.stack.length > 0 && (
                            <div>
                                <h3 className="text-sm tracking-widest text-muted-foreground uppercase mb-4">{tModals('technologies')}</h3>
