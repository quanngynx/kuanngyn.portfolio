...
const DEFAULT_PROJECTS: GalleryStoryItem[] = [
  {
    ...
    descriptions: [
      "Creative branding and digital media campaign for luxury fashion.",
    ],
  },
  {
  ...
  },
  {
    ...
    descriptions: [
      "Minimalist product presentation and digital launch experience.",
    ],
  },
  {
    id: "studio-vale",
...
export function GalleryWork({
  ...
  return (
    <div ref={containerRef} className="w-full px-2 sm:px-6">
      <div className="flex snap-x scrollbar-none items-stretch gap-3 overflow-x-auto pb-4 sm:gap-4">
        {cardItems.map((story) => {
          ...
          return (
            <div
              key={story.id}
              className="gallery-work-card min-w-[13rem] flex-1 shrink-0 snap-start sm:min-w-[15rem]"
            >
              <VideoCard
                project={project}
                ...
                onHoverChange={(hovered) =>
                  setHoveredId(hovered ? story.id : null)
                }
